...
# ----------
#
# Try to find the required ffmpeg components (default: AVFORMAT, AVUTIL,
# AVCODEC)
#
...
# ::
#
# PC_<component>_LIBRARY_DIRS PC_FFMPEG_LIBRARY_DIRS PC_<component>_INCLUDE_DIRS
...
# components headers. FFMPEG_LIBRARIES     - Link these to use the required
# ffmpeg components. FFMPEG_DEFINITIONS   - Compiler switches required for using
# the required ffmpeg components.
#
# For each of the components it will additionally set.
#
# ::
#
# AVCODEC AVDEVICE AVFORMAT AVFILTER AVUTIL POSTPROC SWSCALE
#
# the following variables will be defined
#
# ::
#
# <component>_FOUND        - System has <component> <component>_INCLUDE_DIRS -
...
# ::
#
# FFmpeg::FFmpeg - for all components FFmpeg::<component> - where <component> in
# lower case (FFmpeg::avcodec) for each components
#
# Copyright (c) 2006, Matthias Kretz, <kretz@kde.org> Copyright (c) 2008,
# Alexander Neundorf, <neundorf@kde.org> Copyright (c) 2011, Michael Jansen,
# <kde@michael-jansen.biz> Copyright (c) 2017, Alexander Drozdov,
# <adrozdoff@gmail.com>
#
...
macro(find_component _component _pkgconfig _library _header)
  # if (NOT WIN32) use pkg-config to get the directories and then use these
  # values in the FIND_PATH() and FIND_LIBRARY() calls
  ...
  # message(STATUS ${${_component}_LIBRARIES}) message(STATUS
    ...
    if(${_component}_FOUND)
      ...
      if(NOT TARGET FFmpeg::${_lowerComponent})
        ...
        set_target_properties(
          ...
          PROPERTIES INTERFACE_COMPILE_OPTIONS "${${_component}_DEFINITIONS}"
...
if(NOT TARGET FFmpeg::FFmpeg)
  ...
  set_target_properties(
    FFmpeg
    PROPERTIES INTERFACE_COMPILE_OPTIONS "${FFMPEG_DEFINITIONS}"
