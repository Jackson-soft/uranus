# ##############################################################################
# FindHiredis.cmake Copyright (C) 2017  Belledonne Communications, Grenoble
# France
#
# ##############################################################################
#
...
#
# HIREDIS_FOUND - system has libhiredis HIREDIS_INCLUDE_DIRS - the libhiredis
# include directory HIREDIS_LIBRARIES - The libraries needed to use libhiredis
...
if(HIREDIS_INCLUDE_DIRS AND HIREDIS_LIBRARIES)
  ...
  check_symbol_exists("redisAsyncCommand" "hiredis/async.h"
                      HIREDIS_ASYNC_ENABLED)
  cmake_pop_check_state()
endif()

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(Hiredis DEFAULT_MSG HIREDIS_INCLUDE_DIRS
                                  HIREDIS_LIBRARIES)
